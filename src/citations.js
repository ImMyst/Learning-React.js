module.exports = {
    ...
    citation2: {
        auteur: 'Seth Gueko',
        citation: 'Suis-je métrosexuel si j’encule un contrôleur ?',
    },
    citation3: {
        auteur: 'Seth Gueko',
        citation: 'Dis pas à un zoophile que t’as un chat dans la gorge. ',
    },
    citation4: {
        auteur: 'La Fouine',
        citation: 'À trop haïr les noirs, Le Pen fait des nuits blanches.',
    },
    citation5: {
        auteur: 'Seth Gueko',
        citation: 'J’ai tatoué courage sur ma queue car je prends mon courage à deux mains.',
    },
    citation6: {
        auteur: 'Le Maître Gims',
        citation: 'J’ai deux tours d’avance, comme Mister Ben Laden.',
    },
    citation7: {
        auteur: 'Jazzy Bazz',
        citation: 'T’es plus zoophile que celui qui a découvert le lait de vache.',
    },
    citation8: {
        auteur: 'Youssoupha',
        citation: 'On te baise avec un sourire, et c’est la sodomie sponsorisé par Colgate.',
    },
    citation9: {
        auteur: 'Volts Face',
        citation: 'Je suis pas Naruto mais quand je te baise, t’as l’impression que j’ai neuf queues.',
    },
    citation10: {
        auteur: 'Seth Gueko',
